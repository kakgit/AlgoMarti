...
function fnClearPrevLoginSession(){
    ...
    localStorage.removeItem("isDeltaOptAutoTrader");
...
function fnToggleAutoTrader(){
    ...
    let isLsAutoTrader = localStorage.getItem("isDeltaOptAutoTrader");
    ...
    if(bAppStatus){
        if(isLsAutoTrader === null || isLsAutoTrader === "false"){
            ...
            localStorage.setItem("isDeltaOptAutoTrader", "true");
        }
        else{
            ...
            localStorage.setItem("isDeltaOptAutoTrader", "false");
        }
    }
    else{
