...
function fnGetIndSymSettings(){
    ...
    gIndData = {
        UpdDt: vSecDt, Symbol: [
            { JsonFileName: 'nse_idx_opt.json', SymbolName: 'Nifty 50', SearchSymbol: 'NIFTY', Token: 1, Segment: 'nse_cm', LotSize: 75, MaxLots: 3, StrikeInterval: 50, StopLoss: 10, TakeProfit: 20, ExpiryDates: ['2025-06-05', '2025-06-12', '2025-06-19', '2025-06-26', '2025-07-31'] },
            ...
            { JsonFileName: 'bse_idx_opt.json', SymbolName: 'SENSEX', SearchSymbol: 'SENSEX', Token: 5, Segment: 'bse_cm', LotSize: 20, MaxLots: 50, StrikeInterval: 100, StopLoss: 20, TakeProfit: 40, ExpiryDates: ['2025-06-03', '2025-06-10', '2025-06-17', '2025-06-24', '2025-07-29'] },
            { JsonFileName: 'bse_idx_opt.json', SymbolName: 'BANKEX', SearchSymbol: 'BANKEX', Token: 6, Segment: 'bse_cm', LotSize: 30, MaxLots: 30, StrikeInterval: 100, StopLoss: 20, TakeProfit: 40, ExpiryDates: ['2025-06-24', '2025-07-29'] },
        ] };
