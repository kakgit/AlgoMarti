...
function fnGetIndSymSettings(){
    ...
    gIndData = {
        UpdDt: vSecDt, Symbol: [
            { JsonFileName: 'nse_idx_opt.json', SymbolName: 'Nifty 50', SearchSymbol: 'NIFTY', Token: 1, Segment: 'nse_cm', LotSize: 75, MaxLots: 3, StrikeInterval: 50, StopLoss: 10, TakeProfit: 20, ExpiryDates: ['2025-06-12', '2025-06-19', '2025-06-26', '2025-07-31'] },
